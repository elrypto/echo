...
export class CreateAndExecuteOrder extends React.Component{
    ...
    render(){
        ...
        return (
            <div>
                ...
                {signedOrderRender}
                <PanelBlock>
                    <Button onClick={this.createAndFillOrderAsync} isFullWidth={true} isSize="small" isColor="primary">
                        Purchase
                    </Button>
                </PanelBlock>
            </div>
